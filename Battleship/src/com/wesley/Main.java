...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (game.getPlayer1().getShipsList().size() < numShips) {
        ...
        while (game.getPlayer2().getShipsList().size() < numShips) {
        ...
        while (!win){
            ...
            for (Ship ship : game.getPlayer1().getShipsList()) {
                game.removePointFromShip(ship, response.getRow(), response.getColumn());
